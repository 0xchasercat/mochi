...
- 5705d38: Auto-detect Linux server env, default to `--headless=new`, surface a `headlessMode` option (task 0258).
...
- dd9a3c9: Auto-pick the host-OS-matching profile when `LaunchOptions.profile` is omitted (task 0272 — engineering follow-up to the strategic thesis in task 0271).

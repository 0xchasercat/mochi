...
- The workflow targets `runs-on: ubuntu-latest` for portability — mochi's own self-hosted chaser-runner pool uses the same shape with a different runner label.
